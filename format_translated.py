...
# Get labels from en_dev.csv
# with open('langdata/en_dev.csv', 'r') as f:
#     reader = pd.read_csv(f, delimiter=',', encoding='utf-8')
#     labels = reader['labels'].tolist()

languages = ["hi", "id", "jv", "su", "sw"]

# Get ending1 and ending2 for each language

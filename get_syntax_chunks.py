...
if __name__ == '__main__':
    ...
    lang = args.lang
    df = pd.read_csv(f"/projects/tir4/users/mengyan3/Multilingual-Fig-QA/translate-test/{lang}_{lang}.csv")
    df['x'] = ''
    df['y'] = ''
    df['z'] = ''
    ...
    df.to_csv(f'data/syntax_chunked/syntax_tagged_{lang}.csv', index=False)

# coding=utf-8
# Note: this is an adapted version of this script from Winogrande. 
...
from transformers import (WEIGHTS_NAME, BertConfig,
                                  ...
                                  XLMForMultipleChoice, XLMRobertaForMultipleChoice,
...
ALL_MODELS = ["bert-base-multilingual-cased", "xlm-roberta-base", "xlm-mlm-en-2048"]

MODEL_CLASSES = {
    'mbert': (BertConfig, BertForMultipleChoice, BertTokenizer),
    'xlm': (XLMConfig, XLMForMultipleChoice, XLMTokenizer),
    'xlmr': (XLMRobertaConfig, XLMRobertaForMultipleChoice, XLMRobertaTokenizer),
}
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            inputs = {'input_ids':      batch[0],
                      ...
                      'token_type_ids': batch[2] if args.model_type in ['mbert', 'xlnet', 'bert_mc'] else None,  # XLM don't use segment_ids
                      'labels':         batch[3]}
            #pdb.set_trace()
